...
$headers[] = 'X-Location: -6.405821,106.064193';
        ...
        echo "\n";
        echo "\e[92m--------------------------------------------------\n";
        echo "\e[92m|              CODE BY GILANG GANTENG            |\n";
        echo "\e[92m|              ORA KENTU ORA UWU                 |\n";
        echo "\e[92m|     https://github.com/GilangGanteng           |\n";
        echo "\e[92m|   TOOLS GOJEK AUTO REGIST + REDEM VOUCHER.     |\n";
        echo "\e[92m|                    GANBATTE ONI CHAN ><        |\n";
        echo "\e[92m--------------------------------------------------\n";
        echo "\n";
        ulang:
        ...
        if($regs->success == true) {
            ...
            if($verifs->success == true) {
                ...
                // SANTAI19
                echo "\e[96m[!] Proses Reedem Voucher 20+10 : AXEANTIMATIGAYA \n";
                $data3 = '{"promo_code":"AXEANTIMATIGAYA"}';
                ...
                if($claims->success == true) 
                        {
                            ...
                            {
                                echo "\e[91m [×] Gagal Claim Voucer KONTOL!";
                                    sleep(5);
                                    echo "\n";

                                    // SANTAI11
                                        echo "\e[96m[!] Proses Reedem Voucher 15+10 : EBADAHMAKAN \n";
                                        $data4 = '{"promo_code":"EBADAHMAKAN"}';
